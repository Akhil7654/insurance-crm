...
export default function ReminderDashboard() {
  ...
  const [hideOverdue, setHideOverdue] = useState(true); // collapsed by default
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        {/* 1️⃣ OVERDUE SECTION – always at the top, collapsible */}
        ...
        {/* 2️⃣ TODAY & UPCOMING – always visible */}
        ...
        {/* 3️⃣ EMPTY STATE – only when absolutely no reminders */}
        {notes.length === 0 && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-gray-900 rounded-2xl shadow border p-8 text-center border-gray-800"
          >
