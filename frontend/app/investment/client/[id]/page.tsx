              ...
              <table className="w-full text-sm text-gray-200 border border-gray-800 rounded-lg overflow-hidden">
                <thead className="bg-gray-800">
                  <tr>
                    ...
                    <th className="p-3 border border-gray-700">Investment Amount</th>
                    <th className="p-3 border border-gray-700">Policy Name</th>
                    <th className="p-3 border border-gray-700">Paying Term</th>
                    <th className="p-3 border border-gray-700">Renewal Date</th>
                  </tr>
                </thead>
                ...
                <tbody>
                  {conversions.map((c: any) => (
                    <tr key={c.id} className="text-center hover:bg-gray-800 transition">
                      ...
                      <td className="p-3 border border-gray-800">₹{c.investment_amount}</td>
                      <td className="p-3 border border-gray-800">{c.policy_name}</td>
                      <td className="p-3 border border-gray-800">{c.investment_paying_term}</td>
                      <td className="p-3 border border-gray-800">{c.renewal_date || '-'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2 bg-gray-800 border border-gray-700 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[
                    { value: 'HOT', label: '🔥 HOT', active: 'bg-red-600 text-white border-red-400 shadow-red-500/30' },
                    { value: 'WARM', label: '🌤 WARM', active: 'bg-yellow-500 text-black border-yellow-300 shadow-yellow-500/30' },
                    { value: 'COOL', label: '❄ COOL', active: 'bg-blue-600 text-white border-blue-400 shadow-blue-500/30' },
                  ].map((item) => (
                    <button
                      key={item.value}
                      type="button"
