  ...
  return (
    <div className="mt-6 bg-gray-900 p-6 rounded-2xl shadow-lg border border-gray-800">
      <div className="flex items-center justify-between gap-3 mb-5">
        <h3 className="text-xl font-semibold text-white">Client History</h3>
        ...
        <AnimatePresence initial={false}>
          {visibleNotes.map((note) => (
            <motion.div
              ...
              className="relative pl-6 border-l-4 border-blue-500 bg-gray-950 p-4 rounded-xl hover:shadow-sm transition overflow-hidden"
            >
              {editId === note.id ? (
                <>
                  <textarea
      ...
      {notes.length > 3 && (
        <div className="mt-5 flex justify-center">
          <button
            ...
            className="bg-gray-800 hover:bg-gray-700 text-white px-5 py-2 rounded-xl text-sm font-semibold transition border border-gray-700"
          >
